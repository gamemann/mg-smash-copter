...
- **No loopback netcode suite.** The wire format, the bridge and the link are written and are exercised by the dedicated run as far as the seal; what has not run is two ends talking to each other. That is the next test to write.
